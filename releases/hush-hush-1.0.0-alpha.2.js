(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.features = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"babel-polyfill":2,"filter-objects":298}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":3,"core-js/shim":297,"regenerator-runtime/runtime":300}],3:[function(require,module,exports){
...
(function() {
  ...
  var optionsDefault = {
    doNotCheckInherited: false,     // if true, inherited properties are not checked for match: considering missing properties
    ...
    variables: {},                  // Object of variables w var names as keys
  ...
  function makePropMatchFn(propDefn, options, callback) {
    ...
    var getPropRef = makeGetPropRef(propDefn); 
  ...
  function makeStandardPropMatchFn(propDefn, options) {
    ...
    function standardMatchFn(pObjProp, tObjProp) {
      ...
      var propMatches = 
        ...
        (pObjPropMissingTest(pObjProp, tObjProp) && 
         ...
         bothPropMissingTest(pObjProp, tObjProp) ; 
      return propMatches; 
    }
    ...
    function bothPropMissingTest(pObjProp, tObjProp) {
      return propDefn.matchIfBothPropMissing && 
        !pObjProp.exists &&
        !tObjProp.exists; 
    }
    ...
    function makeReplaceVariableFn() {
      ...
      var replacePObjFn = function(pObjProp, tObjProp) {
        replaceVariable(pObjProp, propDefn.variables);
        return; 
      };

      var replaceTObjFn = function(pObjProp, tObjProp) {
        replaceVariable(tObjProp, propDefn.variables);
        return;
      };
  ...
  function makeGetPropRef(propDefn) {
    //default is to included inherited properties 
    var doesPropertyExist = function(obj, keyName) {
      return _.isObject(obj) && keyName in obj;  
    }

    if(propDefn.doNotCheckInherited === true) {
      // then don't include inherited properties
      doesPropertyExist = function(obj, keyName) {
        return _.isObject(obj) && obj.hasOwnProperty(keyName);
      }
    }

    return function getPropRef (obj, propName) {
      ...
      // while(_.isObject(propRef) && propNameKeys[i] in propRef && i < len) {
      while(doesPropertyExist(propRef, propNameKeys[i]) && i < len) {
